...
def count(founded_classes, im0):
    ...
    for i, (k, v) in enumerate(founded_classes.items()):
        ...
        cv2.putText(im0, str(a), (int(align_right), align_bottom),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (45, 255, 255), 1,
                    cv2.LINE_AA)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    count(founded_classes=founded_classes,
                          im0=im0)  # Applying counter function
